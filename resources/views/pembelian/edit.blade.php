...
function jalankanTambahSesi() {
    ...
    //     let barangId = row.data('id'); // Ambil ID barang dari atribut data-id

    //     console.log({ barangId }); // Debug data

    //     // Konfirmasi penghapusan
    //     if (confirm('Apakah Anda yakin ingin menghapus barang ini?')) {
    //         // Kirim request AJAX untuk memeriksa dan menghapus data
    //         $.ajax({
    //             url: '/pembelian/edit-hapus-sesi', // Endpoint untuk logika penghapusan
    //             method: 'DELETE',
    //             data: {
    //                 id: barangId,
    ...
    //                     row.remove(); // Hapus baris dari tabel jika berhasil
    //                 }
    //             },
    //             error: function(xhr) {
    //                 console.error('Gagal menghapus barang:', xhr.responseText);
...
document.getElementById('kembaliBtn').addEventListener('click', function(e) {
        ...
        sessionStorage.clear();
                ...
                //     const harga = $(this).find('.harga-barang').val();
                //     const jumlah = $(this).find('.jumlah-barang').val();
                //     dataBarang.push({ id: id, harga: harga, jumlah: jumlah });
                // });

                // if (dataBarang.length > 0) {
                //     // Kirim data ke server melalui AJAX
                //     $.ajax({
                //         url: '/pembelian/edit-tambah-sesi', // Endpoint untuk menyimpan data ke sesi
                //         method: 'POST',
                //         data: {
                //             barang: dataBarang,
                //             _token: '{{ csrf_token() }}',
            ...
            // Tangkap perubahan pada input jumlah atau harga barang
